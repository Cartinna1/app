...
export const FULL_BUILDINGS: BuildingDef[] = [
  ...
  // ===== 原料生产（全部需要科技，每种限1） =====
  { id: 'B13', name: '碳氢化合物泵站', description: '钻入沉积层抽取液态碳氢化合物的脉动泵，仿佛在汲取星球黑色的血液。', category: 'material', costGold: 15000, buildTurns: 2, maxCount: 2, minPop: 1, maxPop: 3, outputType: 'material', outputMaterialId: 'oil', popFactor: 1, requiresTech: 'T9', powerConsumption: 3 },
  { id: 'B14', name: '贵金属提取器', description: '通过声波共振粉碎岩层分离出金砂，随后被磁力线俘获并铸成金条。', category: 'material', costGold: 30000, buildTurns: 2, maxCount: 2, minPop: 1, maxPop: 2, outputType: 'material', outputMaterialId: 'gold_ore', popFactor: 1, requiresTech: 'T10', powerConsumption: 3 },
  { id: 'B15', name: '碳沉积采集器', description: '竖立于冻土或古老森林中的吸碳塔，收集空气中与地表沉积的固态碳块。', category: 'material', costGold: 5000, buildTurns: 2, maxCount: 2, minPop: 1, maxPop: 3, outputType: 'material', outputMaterialId: 'carbon', popFactor: 1, requiresTech: 'T11', powerConsumption: 2 },
  { id: 'B16', name: '暗物质捕获阱', description: '深埋于行星内部的探测器阵列，捕捉那些穿透一切物质的暗物质微闪。', category: 'material', costGold: 50000, buildTurns: 3, maxCount: 2, minPop: 1, maxPop: 1, outputType: 'material', outputMaterialId: 'dark_matter', popFactor: 1, requiresTech: 'T12', powerConsumption: 4 },
  { id: 'B17', name: '量子谐振器', description: '共振晶体发出与量子涨落同频的声波，从虚空中震出亚稳态量子簇。', category: 'material', costGold: 50000, buildTurns: 3, maxCount: 2, minPop: 1, maxPop: 1, outputType: 'material', outputMaterialId: 'quantum', popFactor: 1, requiresTech: 'T13', powerConsumption: 4 },
  { id: 'B18', name: '硅晶提取站', description: '扫描整个沙漠或岩层，用激光选择性地熔化含硅矿物，冷却后即得到高纯硅晶。', category: 'material', costGold: 10000, buildTurns: 2, maxCount: 2, minPop: 1, maxPop: 3, outputType: 'material', outputMaterialId: 'silicon', popFactor: 1, requiresTech: 'T14', powerConsumption: 3 },
  { id: 'B19', name: '地壳深钻平台', description: '一座钻透地壳的移动堡垒，触及蕴藏亿万年的古老油藏。', category: 'material', costGold: 40000, buildTurns: 4, maxCount: 2, minPop: 2, maxPop: 4, outputType: 'material', outputMaterialId: 'oil', popFactor: 2, requiresTech: 'T15', powerConsumption: 5 },
  { id: 'B20', name: '碳基材料合成器', description: '将任何有机物快速热解并重组为纯碳结构材料，甚至杂草都能转化为坚固的碳块。', category: 'material', costGold: 10000, buildTurns: 3, maxCount: 2, minPop: 1, maxPop: 4, outputType: 'material', outputMaterialId: 'carbon', popFactor: 2, requiresTech: 'T16', powerConsumption: 4 },
  { id: 'B21', name: '暗物质压缩阱', description: '利用引力透镜将弥散的暗物质聚集压缩，使其变得可见并可用于提取。', category: 'material', costGold: 100000, buildTurns: 4, maxCount: 2, minPop: 1, maxPop: 2, outputType: 'material', outputMaterialId: 'dark_matter', popFactor: 2, requiresTech: 'T17', powerConsumption: 5 },
  { id: 'B22', name: '地核贵金属熔炼厂', description: '直抵地幔的深井，利用行星内热将分散的黄金熔聚成纯矿脉，再抽取至地表。', category: 'material', costGold: 60000, buildTurns: 2, maxCount: 2, minPop: 1, maxPop: 3, outputType: 'material', outputMaterialId: 'gold_ore', popFactor: 2, requiresTech: 'T18', powerConsumption: 5 },
  { id: 'B23', name: '量子晶格锻炉', description: '将谐振器捕获的量子簇放入晶格场中培育生长，最终得到稳定的大块量子晶体。', category: 'material', costGold: 80000, buildTurns: 2, maxCount: 2, minPop: 1, maxPop: 3, outputType: 'material', outputMaterialId: 'quantum', popFactor: 2, requiresTech: 'T19', powerConsumption: 5 },
  { id: 'B24', name: '硅基晶圆制造矩阵', description: '全自动的真空光刻巨构，将硅晶打磨成原子级平整的晶圆，是任何高算力芯片的母体。', category: 'material', costGold: 20000, buildTurns: 3, maxCount: 2, minPop: 2, maxPop: 4, outputType: 'material', outputMaterialId: 'silicon', popFactor: 2, requiresTech: 'T20', powerConsumption: 4 },
